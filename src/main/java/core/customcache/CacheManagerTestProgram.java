...
public class CacheManagerTestProgram {
    ...
    /* This is the object that we are going to cache.  Admittedly this is a
       trivial object to cache.  You might replace our alphabet with a list of every character in the
       world.
    */
		String s = new String("ABCDEFGHIJKLMNOPQRSTUVWXYZ");
    /* Create an instance of CachedObject, set the minutesToLive to 1 minute.  Give the
       object some unique identifier.
    */
		CacheObject co = new CacheObject(s, new Long(1234), 1);
    /* Place the object into the cache! */
		CacheManager.putCache(co);
    /* Try to retrieve the object from the cache! */
		CacheObject o = (CacheObject)CacheManager.getCache(new Long(1234));
